...
<div class="s-notice s-notice__info fs-body2">Articles are available on Stack Internal Enterprise and Business (not Basic or Free). [Find your plan](https://support.stackenterprise.co/support/solutions/articles/22000294292).</div>
...
| End user (by reputation threshold) | - Upload files to API endpoint for ingestion - Manually upload files for Ingestion<br /> - Review, edit, delete, and publish AI-generated content |
